var url = require("url"),
  idps = {
    ...
    dev: {
      ...
      entryPoint:
        "https://login-dev.stanford.edu/idp/profile/SAML2/Redirect/SSO",
      cert: [
    ...
    uat: {
      ...
      entryPoint:
        "https://login-uat.stanford.edu/idp/profile/SAML2/Redirect/SSO",
      cert: [
